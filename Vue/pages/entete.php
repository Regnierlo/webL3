...
<?php
    if ($_SESSION["template"]["connecte"] == false)
    {
        ...
        print   '<form method="'.$type_requete.'" action="inscription.php">';
        print	    '<input id="navigation_inscription" class="champ arrondi fond-rose" type="submit" value="Inscription"/>';
        print   '</form>';
        print   '<form method="'.$type_requete.'" action="connexion.php">';
    ...
    {
        print '<div class="droite">';
        print   '<form method="'.$type_requete.'" action="compte.php">';
