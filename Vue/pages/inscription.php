    ...
    if($_SESSION["template"]["connecte"] == false) {
        ...
        echo
            '<form method="'.$type_requete.'" action="scripts/php/inscription.php">
                ...
                <input class="champ gauche large_50 arrondi fond-violet" type="text" name="saisie_prenom" value="Entrez votre prénom"/>
                <div class="champ gauche large_50">Nom</div>
                <input class="champ gauche large_50 arrondi fond-violet" type="text" name="saisie_nom" value="Entrez votre nom"/>
                <div class="champ gauche large_50">Adresse e-mail</div>
                <input class="champ gauche large_50 arrondi fond-violet" type="text" name="saisie_mail" value="Entrez votre adresse e-mail"/>
